...
class RSICDCapBuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {
        "default": "/mnt/c/Users/user/PycharmProjects/BITA/BITA/BITA//BITA/configs/datasets/rsicd/defaults_cap.yaml"
    }
...
class NWPUCapBuilder(BaseDatasetBuilder):
    ...
    # Replace this path with your own absolute path.
    DATASET_CONFIG_DICT = {
        "default": "/mnt/c/Users/user/PycharmProjects/BITA/BITA/BITA//BITA/configs/datasets/nwpu/defaults_cap.yaml"
    }
...
class UCMCapBuilder(BaseDatasetBuilder):
    ...
    # Replace this path with your own absolute path.
    DATASET_CONFIG_DICT = {
        "default": "/mnt/c/Users/user/PycharmProjects/BITA/BITA/BITA//BITA/configs/datasets/ucm/defaults_cap.yaml"
    }